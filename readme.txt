...
oceanpayment iDEAL payment  plugin

== Description ==
oceanpayment iDEAL payment  plugin

== Installation ==
1.install the Oceanpayment-iDEAL  plug-in in the WordPrwss background.
2.Activate oceanpayment iDEAL in the plugin menu.
